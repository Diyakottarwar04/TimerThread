...
public class MiniLibrary2 {
    public static void main(String[] args) {
        ...
        Book b1 = new Book("The Alchemist", 101, 299.99, "Paulo Coelho");
        Book b2 = new Book("Wings of Fire", 102, 350.0, "A.P.J Abdul Kalam");
        Book b3 = new Book("National Geographic", 201, 120.0, "July");
        Book b4 = new Book("Forbes India", 202, 150.0, "August");
