...
public class UniversityCourseRegistration {
    public static void main(String[] args) {
        ...
        try {
            ...
            courseList.add(new LabCourse("L201", "Operating Systems Lab", 1));
            courseList.add(new TheoryCourse("T102", "Algorithms", 3));
            courseList.add(new LabCourse("L202", "Java Programming Lab", 1));
